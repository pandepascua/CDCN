...
<tr class="table-info">
    ...
    <tr class="table-info">
        ...
        <td> 
                    <div class="row">
                        <div class="col">
                            <input type="text" id="run_alumno" name="run_acupuntura" class="form-control" placeholder="Ej:11111111-k">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <input type="text" id="token_alumno" name="run_acu" class="form-control" placeholder="Ej:11111111-k">
                        </div>
                    </div>
        </td>
