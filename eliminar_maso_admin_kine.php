...
<meta charset="UTF-8">
    ...
    <title>Eliminar ficha masoterapia</title>
</head>
...
<form id="formulario_maso_eli" name="formulario_maso_eli"  action="delete/delete_masoterapia_admin_kine.php" method="post">   
...
<center>
                            ...
                            <table  id="tablamenu" class="table table-hover" style="width:100px; height:100px" >
                                    <tbody>
                                        ...
                                        <tr class="table-info">
                                        <td>run</td>
                                        <td><input type="text" name="run" id="run" class="form-control" placeholder="" required oninput="checkRut(this)"></td>
                ...
                //*******************ALERT DE ENVIO*******************/
                        ...
                        if (confirm('Estas seguro de enviar los datos de este formulario?'))
                                {       
                                        document.formulario_maso_eli.submit();                             
