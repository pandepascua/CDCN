...
<head>
    ...
    <script src="js/cargar_alumno_fecha_psi.js"></script>
...
<div style="float:right" >
  ...
  <p></p>
    ...
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#agendamiento_psi" data-whatever="@mdo">Agendamiento Control del paciente</button>

  
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modificacion_psi" data-whatever="@fat">modificacion agendamiento</button>
    ...
    <a class="btn btn-primary" href="ficha_derivacion_psico_admin.php" role="button">Ingreso ficha derivacion</a>
    <a class="btn btn-primary" href="ficha_derivacion_psico_ver_admin.php" role="button">Ver datos ficha derivacion</a><br><br>
    <a class="btn btn-primary" href="ficha_derivacion_psico_mod_admin.php" role="button">Modificar ficha derivacion</a>
    <a class="btn btn-primary" href="ficha_derivacion_psico_elim_admin.php" role="button">Eliminar ficha derivacion</a>

   
    <a class="btn btn-primary" href="asistencia_control_psi_admin.php" role="button">Ver Asistencia, disponibilidad y agendamiento control</a>
    <a class="btn btn-primary" href="agendar_hora_terapia_psico_admin.php" role="button">Ver hora entrevista Terapia ocupacional</a>

    <a class="btn btn-primary" href="menu_terapia_admin.php" role="button">Terapia ocupacional</a> <br><br>

    <a class="btn btn-primary" href="historial_asistencia_control_psi_admin.php" role="button">Ver historial asistencia agendamiento control</a>

<br><br><br>
       
        </center>        
        <!-- ********************************************** MODAL agendamiento*********************************-->
<div class="modal fade" id="agendamiento_psi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="formulario_psi"name="formulario_psi" action="formulario_control_psi_admin.php" method="post" target="_self">
...
<tbody>
    ...
    <tr class="table-info">
        ...
        <td> 
                <input type="text" id="run_alumno" class="form-control" maxlength="10" required oninput="checkRut(this)" >
                <input type="hidden" id="token_runP" name="run_al" class="form-control" placeholder="Ej:11111111-k">
...
<td>                                                             
    <div class="row">
        <div class="col">
            <input type="text" id="nom_alumnoP" name="nom_alumno" class="form-control" placeholder=""required>
...
<tr class="table-info">
    ...
    <td> 
                <div class="row">
                    <div class="col">
                        <input type="text" id="edad_alumnoP" name="edad_alumno" class="form-control" placeholder=""required>
                    </div>
                </div>
    </td>
</tr>
<tr class="table-info">
              ...
              <td> 
                                      <div class="row">
                                              <div class="col">
                                                      <input type="date" id="fecha_nacP"name="fecha_nac" class="form-control" placeholder="" required>
                                              </div>
                                      </div>
              </td>
</tr>
<tr class="table-info">
              ...
              <td> 
                                      <div class="row">
                                              <div class="col">
                                                      <input type="text" id="telefono_alumnoP"name="telefono_alumno" class="form-control" placeholder="" required>
                                              </div>
                                      </div>
              </td>
</tr>
<tr class="table-info">
              ...
              <td>                                                             
                      <div class="row">
                              <div class="col">
                                      <input type="text" id="nom_apodP"name="nom_apod" class="form-control" placeholder="" required>
                              </div>
                      </div>
              </td>
</tr>
<tr class="table-info">
              ...
              <td> 
                                      <div class="row">
                                              <div class="col">
                                                      <input type="tel" id="fono_apodP"name="tel_apod" maxlength="9" class="form-control" value="9" required>
                                              </div>
                                      </div>
              </td>
</tr>
<tr class="table-info">
              ...
              <td>                                                             
                      <div class="row">
                              <div class="col">
                                      <input type="text" id="direccionP" name="direc_alumno" class="form-control" placeholder="" required>
                              </div>
                      </div>
              </td>
</tr>
<tr class="table-info">
              ...
              <td> 
                                      <div class="row">
                                              <div class="col">
                                                      <input type="text"id="comunaP" name="comuna_alumno" class="form-control" placeholder="" required>
                                              </div>
                                      </div>
              </td>
</tr>
<tr class="table-info">
              ...
              <td>                                                             
                      <div class="row">
                              <div class="col">
                              <input type="email" id="correoP"name="correo_alumno" class="form-control" pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,5}" required>
                              </div>
                      </div>
              </td>
</tr>
<tr class="table-info">
              ...
              <td> 
                                      <div class="row">
                                              <div class="col">
                                                  <textarea id="patologiasP" name="patologias_alumno" cols="30" rows="4"></textarea>												
...
<button type="submit" class="btn btn-success" style="width: 200px" form="formulario_psi">Enviar</button>
...
<!-- ****************************************FIN AGENDAMIENTO*****************************-->
 ...
 <!-- ********************************************** MODAL MODIFICACION*********************************-->
 <div class="modal fade" id="modificacion_psi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog"  role="document">
    <div class="modal-content"  style="width:700px">
      ...
      <div class="modal-body" >
                <p></p>
                        ...
                        <form name="mod_fecha" action="update/mod_fecha_psi_admin.php" method="post" target="_self" ONSUBMIT="return pregunta7();">
                        ...
                        <td><span>R.U.N</span></td>
                            <td> 
                                        <div class="row">
                                            <div class="col">
                                                <input type="text" id="run_alum7" class="form-control" maxlength="10" placeholder="11111111-k" required oninput="checkRut(this)">
                                            </div>
                                        </div>
                                        <input type="hidden" id="token_alum7" name="id_alumno2" class="form-control" placeholder="">
                        ...
                        <form name="mod_hora"action="update/mod_hora_psi_admin.php" method="post" target="_self" ONSUBMIT="return pregunta2();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
                        ...
                        <form name="mod_sala" action="update/mod_sala_psi_admin.php" method="post" target="_self" ONSUBMIT="return pregunta3();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
...
<?php
        ...
        ?>
                        ...
                        <form name="mod_sesion" action="update/mod_sesion_psi_admin.php" method="post" target="_self" ONSUBMIT="return pregunta4();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
                        ...
                        <form name="mod_prof"action="update/mod_prof_psi_admin.php" method="post" target="_self" ONSUBMIT="return pregunta5();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
 ...
 <div class="modal fade" id="eliminacion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="width:700px">
      ...
      <form name="eliminar_alumno"action="delete/delete_alumno_psi_admin.php" method="post" target="_self" ONSUBMIT="return pregunta6();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
 ...
 <div class="modal fade" id="eliminacion_ent" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="width:700px">
      ...
      <form name="eliminar_ent"action="delete/delete_ingreso_psicomotricidad_prof_admin.php" method="post" target="_self" ONSUBMIT="return el_e();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
                        ...
                        <td><span>R.U.N</span></td>
                            ...
                            <script type="text/javascript">
                                ...
                                <td> 
                                <button type="button" class="btn btn-success" style="width: 200px" onclick="el_e();">Eliminar</button>
...
<h3>Entrevista Psicomotricidad</h3>
</center>
<br>
        
                    <center>
            
<form action="filtro_agendamiento_psico.php" method="post"></form>
...
<div class="panel-body cold-md-12 col-lg-10 col-xs-12 col-sm-12 col-lg-offset-1">				
					...
					<div class="col-md-5">
				<input type="date" class="form-control" id="q" placeholder="" onkeyup='load(1);'>
</div>
...
<button type="button" class="btn btn-success" style="width: 200px" onclick='load(1);'>Consultar</button>
	...
	<script type="text/javascript" src="js/buscar_hora_psicomotricidad.js"></script>
</center>
