...
<?php
    ...
    <link rel="shortcut icon" type="image/icon" href="images/favicon.ico"/>
            ...
            <title>Control psicomotricidad</title>
        </head>
...
<div style="float:right" >
  ...
  <p></p>
        ...
        <form id="formulario_psi" name="formulario_psi" action="guardar_DAP.php" method="post" target="_self">
...
<tr class="table-info">
  ...
  <td>  <!-- Campo de entrada de hora -->
      ...
      <input type="time" name="hora" min="09:00"
                                     max="18:00" step="1800"><!--minutos de 30 en 30-->
  </td>
...
<tr class="table-info">
  ...
  <td> 
              <div class="row">
                  <div class="col">
                      <input type="text" id="run_alumno" name="run" class="form-control" maxlength="10" value="<?php echo $_POST['run_al']?>" required oninput="checkRut(this)" readonly>
                  </div>
              </div>
...
<tr class="table-info">
  ...
  <td>                                                             
      <div class="row">
          <div class="col">
              <input type="text" id="nom_alumno" name="nom_alumno" value="<?php echo $_POST['nom_alumno']?>" class="form-control" placeholder=""required readonly>
          </div>
      </div>
  </td>
...
<tr class="table-info">
      ...
      <td> 
                  <div class="row">
                      <div class="col">
                          <input type="text" id="edad_alumno" name="edad" value="<?php echo $_POST['edad_alumno']?>" class="form-control" placeholder=""required readonly>
                      </div>
                  </div>
      </td>
</tr>
<tr class="table-info">
      ...
      <td>                                                             
          <div class="row">
              <div class="col">
                  <input type="text" id="telefono_alumno" name="tel_alumno" value="<?php echo $_POST['telefono_alumno']?>" class="form-control" placeholder=""required readonly>
              </div>
          </div>
      </td>
</tr>
...
<tr class="table-info">
				...
				<td> 
										<div class="row">
												<div class="col">
														<input type="date" name="fecha_nac" class="form-control" value="<?php echo $_POST['fecha_nac']?>" placeholder="" readonly required>
												</div>
										</div>
				</td>
</tr>
<tr class="table-info">
				...
				<td>                                                             
						<div class="row">
								<div class="col">
										<input type="text" name="nom_apod" class="form-control" value="<?php echo $_POST['nom_apod']?>" readonly required>
								</div>
						</div>
				</td>
</tr>
<tr class="table-info">
				...
				<td> 
										<div class="row">
												<div class="col">
														<input type="tel" name="tel_apod" maxlength="9" class="form-control" readonly value="<?php echo $_POST['tel_apod']?>" required>
												</div>
										</div>
				</td>
</tr>
<tr class="table-info">
				...
				<td>                                                             
						<div class="row">
								<div class="col">
										<input type="text" name="direc_alumno" class="form-control"  readonly value="<?php echo $_POST['direc_alumno']?> " required>
								</div>
						</div>
				</td>
</tr>
<tr class="table-info">
				...
				<td> 
										<div class="row">
												<div class="col">
														<input type="text" name="comuna_alumno"  readonly class="form-control" value="<?php echo $_POST['comuna_alumno']?> " required>
												</div>
										</div>
				</td>
</tr>
<tr class="table-info">
				...
				<td>                                                             
						<div class="row">
								<div class="col">
								<input type="email" name="correo_alumno" class="form-control" readonly pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,5}" value="<?php echo $_POST['correo_alumno']?> "required>
								</div>
						</div>
				</td>
</tr>
<tr class="table-info">
				...
				<td> 
										<div class="row">
												<div class="col">
													<input type="text" style="width:300px" readonly name="patologia_alumno"  value="<?php echo $_POST['patologias_alumno']?> ">												
...
<button type="submit" class="btn btn-primary" style="width: 200px" value="enviar" form="formulario_psi" >Enviar Datos</button>
