...
<head>
    ...
    <link rel="stylesheet" href="menuvar.css">
...
<div style="float:right" >
  ...
  <p></p>
    ...
    <a class="btn btn-primary" href="ficha_derivacion_psico.php" role="button">Ingreso ficha derivacion</a><br><br>
    <a class="btn btn-primary" href="ficha_derivacion_psico_ver.php" role="button">Ver datos ficha derivacion</a>
    <a class="btn btn-primary" href="ficha_derivacion_psico_mod.php" role="button">Modificar ficha derivacion</a>
    <a class="btn btn-primary" href="ficha_derivacion_psico_elim.php" role="button">Eliminar ficha derivacion</a>

   
    <a class="btn btn-primary" href="asistencia_control_psi.php" role="button">Ver Asistencia, disponibilidad y agendamiento control</a><br><br>
    <a class="btn btn-primary" href="agendar_hora_terapia_psico.php" role="button">Ver hora entrevista Terapia ocupacional</a>

    <a class="btn btn-primary" href="menu_terapia.php" role="button">Terapia ocupacional</a>

   
    <a class="btn btn-primary" href="historial_asistencia_control_psi.php" role="button">Ver historial asistencia agendamiento control</a>
...
<div class="modal fade" id="agendamiento_psi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="formulario_psi"name="formulario_psi" action="formulario_control_psi.php" method="post" target="_self">
    ...
    <div class="modal-content"  style="width:700px">
      ...
      <div class="modal-body" >
                <p></p>
                        ...
                        <form name="mod_fecha" action="update/mod_fecha_psi.php" method="post" target="_self" ONSUBMIT="return pregunta7();">
 ...
 <div class="modal fade" id="eliminacion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="width:700px">
      ...
      <form name="eliminar_alumno"action="delete/delete_alumno_psi.php" method="post" target="_self" ONSUBMIT="return pregunta6();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
 ...
 <div class="modal fade" id="eliminacion_ent" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="width:700px">
      ...
      <form name="eliminar_ent"action="delete/delete_ingreso_psicomotricidad_prof.php" method="post" target="_self" ONSUBMIT="return el_e();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
