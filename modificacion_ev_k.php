...
<head>
    ...
    <title>Modificación evaluación kinésica</title>
</head>
...
<img src="images/logocor.png" width="100px" height="100px"/>
    ...
    <form id="form_ek2" name="form_ek2" method="post" action="update/ficha_ev_k_mod.php">
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-info">
                                            <td> 
                                                <div class="row">
                                                    <div class="col">
                                                        <input type="text" id="segmento2" name="seg2" class="form-control" placeholder="">
                                                    </div>
                                                </div>
                                            </td>
                                            <td> 
