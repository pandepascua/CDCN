...
<div class="modal fade" id="agendamiento_nut" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form name="formulario_agen_nu" action="guardar_hora_nutricion_admin.php" method="post" target="_self" ONSUBMIT="return pregunta();">
...
<tbody>
    ...
    <tr class="table-info">
        ...
        <td> 
                <input type="text" id="run_alumno" class="form-control" pmaxlength="10" placeholder="11111111-k" required oninput="checkRut(this)">
                <input type="hidden" id="token_alumnoN" name="id_alumno" class="form-control" placeholder="Ej:11111111-k">
...
<tr class="table-info">
        ...
        <td>                                                             
            <div class="row">
                <div class="col">
                    <input type="text" id="nom_alumnoN" class="form-control" readonly>
                </div>
            </div>
        </td>
    ...
    <div class="modal-content"  style="width:700px">
      ...
      <div class="modal-body" >
                <p></p>
                        ...
                        <form name="mod_fecha" action="update/mod_fecha_ingreso_nut_admin.php" method="post" target="_self" ONSUBMIT="return pregunta7();">
                        ...
                        <form name="mod_hora"action="update/mod_hora_ingreso_nut_admin.php" method="post" target="_self" ONSUBMIT="return pregunta2();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
                        ...
                        <td><span>R.U.N</span></td>
                            <td> 
                                        ...
                                        <input type="hidden" id="token_id_al_h_nut" name="id_alumno" class="form-control" placeholder="">
 ...
 <div class="modal fade" id="eliminacion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="width:700px">
      ...
      <form name="eliminar_alumno"action="delete/delete_ingreso_nut.php" method="post" target="_self" ONSUBMIT="return pregunta5();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
