...
<center>
    ...
    <form name="formulario_terapia_eli" id="eli_terapia" action="delete/delete_terapia_admin.php" method="post" target="_self" ONSUBMIT="return pregunta();">
...
<script type="text/javascript">
                //*******************ALERT DE ENVIO*******************/
                        ...
                        if (confirm('Estas seguro de enviar los datos de este formulario?'))
                                {       
                                        document.formulario_terapia_eli.submit();                             
