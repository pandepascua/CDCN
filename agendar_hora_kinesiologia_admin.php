...
<div class="modal fade" id="agendamiento_nut" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form name="formulario_agen_nu" action="guardar_hora_kinesiologia_admin.php" method="post" target="_self" ONSUBMIT="return pregunta();">
...
<tbody>
    <tr class="table-info">
        <td>
            ...
            <input type="date" name="fecha_kinesiologia" min="2019-01-01"
                                            max="2030-01-01" step="1">
           
          </td>
        <td>  <!-- Campo de entrada de hora -->
            
            <input type="time" name="hora_kinesiologia" min="09:00"
                                           max="18:00" step="1800">
        </td>
    ...
    <tr class="table-info">
        ...
        <td> 
                ...
                <input type="hidden" id="token_alumnoK" name="id_alumno" class="form-control" placeholder="Ej:11111111-k">
...
<tr class="table-info">
        ...
        <td>                                                               
            <div class="row">
                <div class="col">
                    <input type="text" id="nom_alumnoK" class="form-control" placeholder="">
                </div>
            </div>
        </td>
    ...
    <div class="modal-content"  style="width:700px">
      ...
      <div class="modal-body" >
                <p></p>
                        ...
                        <form name="mod_fecha" action="update/mod_fecha_ingreso_kinesiologia_admin.php" method="post" target="_self" ONSUBMIT="return pregunta7();">
                        ...
                        <td><span>R.U.N</span></td>
                            <td> 
                                        ...
                                        <input type="hidden" id="token_id_f" name="id_alumno2" class="form-control" placeholder="">
                        ...
                        <form name="mod_hora"action="update/mod_hora_ingreso_kinesiologia.php" method="post" target="_self" ONSUBMIT="return pregunta2();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
                        ...
                        <td><span>R.U.N</span></td>
                            <td> 
                                        ...
                                        <input type="hidden" id="token_id_al_h_kine" name="id_alumno" class="form-control" placeholder="">
 ...
 <div class="modal fade" id="eliminacion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="width:700px">
      ...
      <form name="eliminar_alumno"action="delete/delete_ingreso_kinesiologia.php" method="post" target="_self" ONSUBMIT="return preguntaE();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
                        ...
                        <td><span>R.U.N</span></td>
                            <td> 
                                        <div class="row">
                                            <div class="col">
                                                <input type="text" id="run_alumno_el" class="form-control" maxlength="10" placeholder="11111111-k" required oninput="checkRut(this)">
                                                <input type="hidden" id="el_alumno_id" name="id_alumno" class="form-control" placeholder="">
...
<form action="filtro_agendamiento_kinesiologia.php" method="post"></form>
