  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <h4>Ficha Inscripcion</h4>
                        <form id="form_dg" name="form_dg" method="post" action="formulario_dg_admin.php">
...
<div class="modal fade" id="modificar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <h4>Ficha Inscripcion</h4>
                        <form id="form_dg_mod" name="form_dg_mod" method="post" action="ficha_datos_generales_admin.php">
                                <table  id="tablamenu" class="table table-hover" style="width:470px; height:150px"  >
                                        <thead>
                                        </thead>
                                        <tbody>
...
<div class="modal fade" id="eliminar_dg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <h4>Ficha Inscripcion</h4>
                        <form id="form_dg_el" name="form_dg_el" method="post" action="eliminar_dg_admin.php">
                                <table  id="tablamenu" class="table table-hover" style="width:470px; height:150px"  >
                                        <thead>
                                        </thead>
                                        <tbody>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" style="width: 200px" value="enviar" form="form_dg_el" >Continuar</button>
                    ...
                    <h4>Evaluacion Funcional</h4>
                                           ...
                                           <a class="btn btn-primary" href="evaluacion_funcional_ingreso_admin.php" role="button">Ir a ficha</a> 
                                           <a class="btn btn-primary" href="evaluacion_funcional_mod_admin.php" role="button">Modificar ficha</a> 
                                           <a class="btn btn-primary" href="evaluacion_funcional_eliminar_admin.php" role="button">Eliminar ficha</a> 
                ...
                <!--***********************************evaluacion kinesica**********************************************-->
                    ...
                    <a class="btn btn-primary" href="registro_ficha_ev_k_admin.php" role="button">Ir a ficha</a> 
                    <a class="btn btn-primary" href="modificacion_ev_k_admin.php" role="button">Modificar ficha</a> 
                    <a class="btn btn-primary" href="eliminar_ev_k_admin.php" role="button">Ver y eliminar ficha</a> 
                    ...
                    <a class="btn btn-primary" href="registro_ficha_maso_admin.php" role="button">Ir a ficha</a> 
                    <a class="btn btn-primary" href="modificacion_maso_admin.php" role="button">Modificar ficha</a> 
                    <a class="btn btn-primary" href="eliminar_maso_admin.php" role="button">Eliminar ficha</a> 
