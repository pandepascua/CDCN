...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <title>Historial asistencia control nutrición</title>
</head>
...
<div style="float:right" >
  ...
  <a href=logout_adminut.php><button type="button" class="btn btn-success"> Cerrar Sesion</button></a>
...
<div class="panel-body cold-md-12 col-lg-10 col-xs-12 col-sm-12 col-lg-offset-1">				
					...
					<div class="col-md-5">
				<input type="text" class="form-control" id="q" placeholder="run del alumno" onkeyup='load(1);'>
</div>
...
<div id="resultados"></div><!-- Carga los datos ajax -->
	...
	<script type="text/javascript" src="js/historial_asistencia_control_nut.js"></script>
</center>
