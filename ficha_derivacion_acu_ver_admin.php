...
<head>
        ...
        <title>Ver Ficha Derivación</title>
</head>
...
<div style="float:right" >
  ...
  <p></p>
        ...
        <p></p>
        <a class="btn btn-primary" href="acupuntura_admin.php" role="button">Ir Atrás</a>     
        <p></p>  
        <center>
        ...
        <tr class="table-info">
            ...
            <form id="form_ficha_der" name="form_ficha_der"  action="" method="post">
