...
<div style="float:right" >
  ...
  <p></p>
        ...
        <center>
                ...
                <h3>Modificar Hora Agendamiento Nutrición</h3>
                <p></p>
           
                        <form name="mod_fecha" action="update/mod_fecha_nut.php" method="post" target="_self" ONSUBMIT="return pregunta();">
            ...
            <p></p>
            <br>
            <h3>Eliminar Paciente de Agendamiento Nutrición</h3>
            <p></p>
