...
<head>
    ...
    <title>Agendamiento Psicomotricidad</title>
</head>
...
<div style="float:right" >
  ...
  <p></p>
        ...
        <center>
            ...
            <h3>Agendamiento Psicomotricidad</h3>
            <br>
            <form name="formulario_agen_psi" action="guardar_DAP.php" method="post" target="_self" ONSUBMIT="return pregunta();">
...
<tr class="table-info">
        <td>
            ...
            <input type="date" name="fecha_psi" min="2019-01-01"
                                            max="2030-01-01" step="1">
           
          </td>
        <td>  <!-- Campo de entrada de hora -->
            
            <input type="time" name="hora_psi" min="09:00"
                                           max="18:00" step="1800">
        </td>
    ...
    <tr class="table-info">
            ...
            <td> 
                        <div class="row">
                            <div class="col">
                                <input type="text" id="nom_apod" name="apoderado_psi" class="form-control" placeholder="">
                            </div>
                        </div>
            </td>
            ...
            <td>                                                             
                <div class="row">
                    <div class="col">
                        <input type="text"  name="diagnostico_psi" class="form-control" placeholder="">
                    </div>
                </div>
            </td>
    </tr>
    <tr class="table-info">
            ...
            <td><span>Derivación.</span></td>
            <td>                                                             
                <div class="row">
                    <div class="col">
                        <input type="text" name="derivacion_psi" class="form-control" placeholder="">
                    </div>
                </div>
            </td>
    </tr>
...
<?php
        ...
        ?>
            ...
            <td>                                      
                        <input type="text" name ="sesion_psi"class="form-control" placeholder="">
...
<script type="text/javascript">
                //*******************ALERT DE ENVIO*******************/
                        ...
                        if (confirm('Estas seguro de enviar los datos de este formulario?'))
                                {       
                                        document.formulario_agen_psi.submit();                             
...
<button type="button" class="btn btn-success" style="width: 200px" onclick="pregunta();">Enviar</button>
    ...
    <P></P>
    <h6>CONSULTA DE AGENDAMIENTO</h6>  
    <P></P>  
