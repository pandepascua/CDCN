...
<form id="formulario_maso_eli" name="formulario_maso_eli"  action="delete/delete_masoterapia.php" method="post">   
...
<center>
                            ...
                            <table  id="tablamenu" class="table table-hover" style="width:100px; height:100px" >
                                    <tbody>
                                        ...
                                        <tr class="table-info">
                                        <td>run</td>
                                        <td><input type="text" name="run" id="run" class="form-control" placeholder="11111111-1" required oninput="checkRut(this)"></td>
