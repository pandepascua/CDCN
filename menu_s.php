    ...
    <h3>Lista de tratamientos.</h3>
        ...
        <tbody>
         ...
         <tr class="table-info">
            ...
            <tr class="table-info">
                    <td><span>Lista de talleres.</span></td>
                    <td> <ul class="nav nav-pills nav-fill"><li class="nav-item"><a class="nav-link active" href="lista_talleres_p.php">Continuar</a></li></ul></td>
            </tr>
