...
<div style="float:right" >
  ...
  <p></p>
    ...
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modificacion_kine" data-whatever="@fat">modificación agendamiento control</button>
    ...
    <a class="btn btn-primary" href="ficha_derivacion_kinesiologia.php" role="button">Ingreso ficha derivación</a><br><br>
    <a class="btn btn-primary" href="ficha_derivacion_kine_ver.php" role="button">Ver datos ficha derivación</a>
    <a class="btn btn-primary" href="ficha_derivacion_kine_mod.php" role="button">Modificar ficha derivación</a>
    <a class="btn btn-primary" href="ficha_derivacion_kine_elim.php" role="button">Eliminar ficha derivación</a>
    <a class="btn btn-primary" href="asistencia_control_kine.php" role="button">Ver Asistencia, disponibilidad y agendamiento control</a><br> <br>
    <a class="btn btn-primary" href="historial_asistencia_control_kine.php" role="button">Ver historial asistencia agendamiento control</a>
    <a class="btn btn-primary" href="fichakinemaso_kine.php" role="button">Fichas masoterapia y kinesiología.</a><br> <br>
...
<div class="modal fade" id="agendamiento_kine" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="formulario_kine"name="formulario_kine" action="formulario_control_kine.php" method="post" target="_self">
    ...
    <div class="modal-content"  style="width:700px">
      ...
      <div class="modal-body" >
                ...
                <p></p>
                        ...
                        <form name="mod_fecha" action="update/mod_fecha_kine.php" method="post" target="_self" ONSUBMIT="return pregunta7();">
                        ...
                        <form name="mod_hora"action="update/mod_hora_kine.php" method="post" target="_self" ONSUBMIT="return pregunta2();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
                        ...
                        <form name="mod_sala" action="update/mod_sala_kine.php" method="post" target="_self" ONSUBMIT="return pregunta3();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
...
<?php
        ...
        ?>
                        ...
                        <form name="mod_sesion" action="update/mod_sesion_kine.php" method="post" target="_self" ONSUBMIT="return pregunta4();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
                        ...
                        <form name="mod_prof"action="update/mod_prof_kine.php" method="post" target="_self" ONSUBMIT="return pregunta5();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
 ...
 <div class="modal fade" id="eliminacion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="width:700px">
      ...
      <form id="eliminar_alumno" name="eliminar_alumno"action="delete/delete_alumno_kine.php" method="post" target="_self"">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
 ...
 <div class="modal fade" id="eliminacion_entrevista" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="width:700px">
      ...
      <form name="eliminar_alumno_entrevista"action="delete/delete_ingreso_kinesiologia_prof.php" method="post" target="_self" ONSUBMIT="return preguntaE();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
