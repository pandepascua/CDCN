...
<div style="float:right" >
  ...
  <p></p>
        ...
        <p></p>
            <a class="btn btn-primary" href="fichakinemaso_admin_kine.php" role="button">Ir Atrás</a>    
            <a class="btn btn-primary" href="menu.php" role="button">Ir al menú</a> 
        </p>
    


        <form name="formulario_evaluacion" action="guardar_evaluacion_admin_kine.php" method="post" target="_self" ONSUBMIT="return pregunta();">
<center>
                                ...
                                <table  id="tablamenu" class="table table-hover" style="width:200px; height:200px" >
                                        <tbody>
                                            ...
                                            <tr class="table-info">                                                                                                         
                                                    ...
                                                    <td> <div class="row">
                                                            <div class="col">
                                                                <input type="radio" name="trapecio_superior" class="form-control" placeholder="">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td> <div class="row">
                                                            <div class="col">
                                                                <input type="radio" name="trapecio_medio" class="form-control" placeholder="">
                                                            </div>
                                                        </div>
                                                    </td>
                                            ...
                                            <tr class="table-info">
                                                    ...
                                                    <td> <div class="row">
                                                            <div class="col">
                                                                <input type="radio" name="elevador_e" class="form-control" placeholder="">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td> <div class="row">
                                                            <div class="col">
                                                                <input type="radio" name="trapecio_inf" class="form-control" placeholder="">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>Trapecio inf.</td>
                                            ...
                                            <tr class="table-info">
                                                    ...
                                                    <td> <div class="row">
                                                            <div class="col">
                                                                <input type="radio" name="p_mayor" class="form-control" placeholder="">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td> <div class="row">
                                                            <div class="col">
                                                                <input type="radio" name="serrato_ant" class="form-control" placeholder="">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>Serrato ant.</td>
                                            ...
                                            <tr class="table-info">
                                                    ...
                                                    <td> <div class="row">
                                                            <div class="col">
                                                                <input type="radio" name="ecom" class="form-control" placeholder="">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td> <div class="row">
                                                            <div class="col">
                                                                <input type="radio" name="romboides" class="form-control" placeholder="">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>Romboides.</td>
                                ...
                                <table  id="tablamenu" class="table table-hover" style="width:100px; height:100px" >
                                        <tbody>
                                            ...
                                            <tr class="table-info">                                                                                                         
                                                    ...
                                                    <td> <div class="row">
                                                            <div class="col">
                                                                <input type="radio" name="psoas" class="form-control" placeholder="">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td> <div class="row">
                                                            <div class="col">
                                                                <input type="radio" name="gluteos" class="form-control" placeholder="">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>Glúteos</td>
                                            ...
                                            <tr class="table-info">
                                                    ...
                                                    <td> <div class="row">
                                                            <div class="col">
                                                                <input type="radio" name="r_anterior" class="form-control" placeholder="">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td> <div class="row">
                                                            <div class="col">
                                                                <input type="radio" name="abdominales" class="form-control" placeholder="">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>Abdominales.</td>
                                            ...
                                            <tr class="table-info">
                                                    ...
                                                    <td> <div class="row">
                                                            <div class="col">
                                                                <input type="radio" name="tfl" class="form-control" placeholder="">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td></td>
                                            ...
                                            <tr class="table-info">
                                                    ...
                                                    <td> <div class="row">
                                                            <div class="col">
                                                                <input type="radio" name="extensores" class="form-control" placeholder="">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td></td>
                                                    ...
                                                    <td> <div class="row">
                                                            <div class="col">
                                                                <input type="radio" name="aductores" class="form-control" placeholder="">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td></td>
