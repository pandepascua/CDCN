...
<link rel="shortcut icon" type="image/icon" href="images/favicon.ico"/>
    ...
    <title>Modificar Ficha evaluación funcional</title>
</head>
...
<div style="float:right" >
  ...
  <p></p>
        ...
        <form name="formulario_evaluacion_mod" id="modificar_evaluacion" action="mod_evaluacion.php" method="post" target="_self" ONSUBMIT="return pregunta();">
<center>
<table  id="tablamenu" class="table table-hover" style="width:1000px; height:150px" >
                                        ...
                                        <tbody>
                                            <tr class="table-info">
                                                ...
                                                <td>                                                             
                                                        <div class="row">
                                                            <div class="col">
                                                                <input type="text" name="run" id="run_1" class="form-control" placeholder=""oninput="checkRut(this)">
                ...
                //*******************ALERT DE ENVIO*******************/
                        ...
                        if (confirm('Estas seguro de enviar los datos de este formulario?'))
                                {       
                                        document.formulario_evaluacion_mod.submit();                             
