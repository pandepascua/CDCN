...
<head>
    ...
    <title>Eliminar y modificar</title>
</head>
...
<div style="float:right" >
  ...
  <p></p>
        ...
        <center>
                ...
                <h3>Modificar Alumno de taller</h3>
                <p></p>
                    ...
                    <tbody>
                        ...
                        <tr class="table-info">
                            ...
                            <td> 
                                        <div class="row">
                                            <div class="col">
                                                <input type="text" class="form-control" placeholder="Ej:11111111-k">
                                            </div>
                                        </div>
                            </td>
                            <td><span></span></td>
                        ...
                        <tr class="table-info">
                                ...
                                <td> 
                                    <button type="button" class="btn btn-success" style="width: 100px">Modificar</button>    
            ...
            <p></p>
            <br>
            <h3>Eliminar Alumno de taller</h3>
            <p></p>
            <table  id="tablamenu" class="table table-hover" style="width:1000px; height:50px" >
                    <thead>
