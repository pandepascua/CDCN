...
<div style="float:right" >
  ...
  <p></p>
        ...
        <p></p>
                <a class="btn btn-primary" href="lista_talleres_p.php" role="button">Ir Atrás</a>     
                <p></p>
<center>
        
    <h3>Asistencia Alumnos</h3>
    <br>
    <form name="formulario_asistencia" action="guardar_asistencia_s.php" method="post" target="_self" ONSUBMIT="return pregunta();">
