...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <title>Historial asistencia control kinesiologia</title>
</head>
...
<div style="float:right" >
  ...
  <p></p>
        ...
        <p></p>
                ...
                <p></p>
                <center>
<h3>Historial Agendamiento de control</h3>
</center>
<br>
          <center>
<table  id="tablamenu" class="table table-hover" style="width:600px; height:100px" >
...
<tr class="table-info">
     <td>
				...
				<input  type="text" class="form-control" id="q" placeholder="ingrese run o nombre del alumno" onkeyup='load(1);'>
</div>
...
<div id="resultados"></div><!-- Carga los datos ajax -->
	...
	<script type="text/javascript" src="js/historial_asistencia_control_kine.js"></script>
</center>
