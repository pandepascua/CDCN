...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <title>Historial asistencia control acupuntura</title>
</head>
...
<br>
          <center>
<form id="formulario_asistencia"action="guardado_control_asistencia_acu.php" method="post">
...
<div id="resultados"></div><!-- Carga los datos ajax -->
	...
	<script type="text/javascript" src="js/historial_asistencia_control_acu.js"></script>
</center>
