...
$action='ajax';
	if($action == 'ajax'){
		...
		$sql="SELECT id_agen_acupuntura,run_alumno,nom_alumno,edad,telefono,correo,
        talleres.nom_taller,talleres.id_taller,tipo_asistencia.id_tipo_asis,tipo_asistencia.tipo_asis,fecha_acupuntura,hora_acupuntura,motivo_consulta_acupuntura,diagnostico_acupuntura,observacion_acupuntura,sesion,salas.id_sala,salas.nom_sala,profesionales.nom_profesional,profesionales.id_profesional  
        FROM  $sTable 
		inner join tipo_asistencia on(asis_control_acu_ing.id_tipo_asis=tipo_asistencia.id_tipo_asis)
        inner join talleres on(asis_control_acu_ing.id_taller=talleres.id_taller)
        inner join salas on(asis_control_acu_ing.id_sala=salas.id_sala)
        inner join profesionales on(asis_control_acu_ing.id_profesional=profesionales.id_profesional) 
