...
$action='ajax';
	if($action == 'ajax'){
         $q = mysqli_real_escape_string($con,(strip_tags($_REQUEST['q'], ENT_QUOTES)));
		  $sTable = "asistencia_control_maso_ing";
		 $sWhere = "";
		...
		$reload = './mostrar_agendamiento_masoterapia.php';
		//main query to fetch the data
		$sql="SELECT id_agen_masoterapia,tipo_asistencia.tipo_asis,tipo_asistencia.id_tipo_asis,run_alumno,nom_alumno,edad,telefono,correo,
        talleres.nom_taller,talleres.id_taller,fecha_maso,hora_maso,atencion_maso , observacion_maso , sesion_maso, 
                            estado_maso ,ejercicio_maso, proced_tens_maso , 
                            proced_us_maso,proced_chc_maso,proced_ir_maso ,salas.id_sala,salas.nom_sala,profesionales.nom_profesional,profesionales.id_profesional  
        FROM  $sTable 
        inner join talleres on(asistencia_control_maso_ing.id_taller=talleres.id_taller)
        inner join salas on(asistencia_control_maso_ing.id_sala=salas.id_sala)
        inner join profesionales on(asistencia_control_maso_ing.id_profesional=profesionales.id_profesional) 
		inner join tipo_asistencia on(asistencia_control_maso_ing.id_tipo_asis=tipo_asistencia.id_tipo_asis) 
