...
<center><h3>Lista de talleres</h3>
			...
			<div class="panel-body cold-md-12 col-lg-10 col-xs-12 col-sm-12 col-lg-offset-1">
				...
				<tr class="table-info">
							...
							<a class="btn btn-primary" href="cupos_admin.php" role="button">Cupos</a>
							<a class="btn btn-primary" href="asistencia_admin.php" role="button"> Asistencia</a>
							<a class="btn btn-primary" href="ficha_derivacion_admin.php" role="button">ficha derivación</a>    
							<a class="btn btn-primary" href="ficha_derivacion_ver_admin.php" role="button">Ver datos ficha derivacion</a>
    <a class="btn btn-primary" href="ficha_derivacion_mod_admin.php" role="button">Modificar ficha derivacion</a><br><br>
    <a class="btn btn-primary" href="ficha_derivacion_elim_admin.php" role="button">Eliminar ficha derivacion</a>           
							</center>
...
<div class="modal fade" id="inscripcion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="formulario_inscripcion" name='formulario_inscripcion' action="guardar_alumno_admin.php" method="post" target="_self"  ><!--ONSUBMIT="return pregunta();"-->
...
<tr class="table-info">
				...
				<td> 
										<div class="row">
												<div class="col">
													<textarea name="patologia_alumno" cols="30" rows="4"></textarea>												
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="width:700px">
      ...
      <div class="modal-body">
			...
			<form id="mod_taller"name="mod_taller" action="update/taller_alumno_admin.php" method="post" target="_self" ><!--ONSUBMIT="return pregunta1();"-->
...
<!--
		<script type="text/javascript">
			...
			<form id="mod_comuna"name="mod_comuna"action="update/comuna_admin.php" method="post" target="_self">
<table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
...
<td><span>R.U.N</span></td>
		<td> 
			...
			<form id="mod_nom_apod" name="mod_nom_apod"action="update/apoderado_alumno_admin.php" method="post" target="_self" >
<table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
...
<td><span>R.U.N</span></td>
		<td> 
			...
			<form id="mod_fono_apod" name="mod_fono_apod"action="update/fono_apoderado_admin.php" method="post" target="_self" >
<table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
...
<td><span>R.U.N</span></td>
		<td> 
			...
			<form id="mod_edad" name="mod_edad"action="update/edad_alumno_admin.php" method="post" target="_self">
<table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
...
<td><span>R.U.N</span></td>
		<td> 
			...
			<form id="mod_patologia"name="mod_patologia"action="update/patologia_alumno_admin.php" method="post" target="_self" >
<table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
...
<td><span>R.U.N</span></td>
		<td> 
			...
			<form id="mod_fono_alumno"name="mod_fono_alumno"action="update/fono_alumno_admin.php" method="post" target="_self">
<table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
...
<td><span>R.U.N</span></td>
		<td> 
			...
			<form id="mod_direccion" name="mod_direccion" action="update/direccion_alumno_admin.php" method="post" target="_self" >
...
<form id="mod_correo" name="mod_correo"action="update/correo_alumno_admin.php" method="post" target="_self" >
<table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
...
<div class="modal fade" id="eliminar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
	...
	<div class="modal-header">
      ...
      <form id="eliminar_alumno"name="eliminar_alumno"action="delete/delete_alumno_taller_admin.php" method="post" target="_self" >
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
                        ...
                        <td><span>R.U.N</span></td>
                            <td> 
                                ...
                                <td> 
                                <button type="button" class="btn btn-success" style="width: 200px" form="eliminar_alumno">Eliminar</button>
