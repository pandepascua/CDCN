...
<center>
        ...
        <table  id="tablamenu" class="table table-hover" style="width:700px; height:200px" >
                ...
                <tr class="table-info">
                    ...
                    <tr class="table-info">
                    <td><span>Disponibilidad de cupos para taller</span></td>
                    <td> <ul class="nav nav-pills nav-fill"><li class="nav-item"><a class="nav-link active" href="cupos.php">Continuar</a></li></ul></td>
                    </tr>   
                    <tr class="table-info">
                        <td><span>Inscripción del alumno.</span></td>
                    ...
                    <tr class="table-info">
                        <td><span>Asistencia alumnos.</span></td>
                    ...
                    <tr class="table-info">
                        <td><span>Modificacion y eliminacion de alumnos.</span></td>
                    ...
                    <tr class="table-info">
                    <td><span>Ficha derivacion</span></td>
                    <td> <ul class="nav nav-pills nav-fill"><li class="nav-item"><a class="nav-link active" href="ficha_derivacion.php">Continuar</a></li></ul></td>
                    </tr>    
                </tbody>
        </table>
    </center>
