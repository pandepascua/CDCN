...
<div style="float:right" >
  ...
  <p></p>
        ...
        <form name="formulario_evaluacion_eli" id="eliminar_evaluacion" action="delete/delete_evaluacion.php" method="post" target="_self" ONSUBMIT="return pregunta();">
<center>
                                        ...
                                        <tbody>
                                            <tr class="table-info">
                                                ...
                                                <td>                                                             
                                                        <div class="row">
                                                            <div class="col">
                                                                <input type="text" name="run" id="run_1" class="form-control" placeholder="">
                                                                <input type="hidden" name="id_evaluacion_1" id="id_evaluacion_1" class="form-control" placeholder="" required oninput="checkRut(this)">
