...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <title>Asistencia control nutrición</title>
</head>
...
<br>
          <center>
<form id="formulario_asistencia"action="guardado_control_asistencia_nut.php" method="post">
...
<div id="resultados"></div><!-- Carga los datos ajax -->
	...
	<script type="text/javascript" src="js/asistencia_control_nut.js"></script>
</center>
