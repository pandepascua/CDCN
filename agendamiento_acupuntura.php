...
<meta charset="UTF-8">
    ...
    <title>Agendamiento Acupuntura</title>
</head>
...
<center>
    ...
    <h3>Agendamiento Acupuntura</h3>
    <br>
    <form name="formulario_acu" action="guardar_DAA.php" method="post" target="_self" ONSUBMIT="return pregunta();">
...
<tr class="table-info">
    ...
    <tr class="table-info">
        ...
        <td> 
                    <div class="row">
                        <div class="col">
                            <input type="text" id="run_alumno" name="run_acupuntura" class="form-control" placeholder="11111111-1" required oninput="checkRut(this)">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <input type="hidden" id="token_alumno" name="run_acu" class="form-control" placeholder="Ej:11111111-k">
                        </div>
                    </div>
        </td>
        ...
        <td>                                                             
            <div class="row">
                <div class="col">
                    <input type="text" id="nom_alumno" name="nom_alumno" class="form-control" placeholder="">
                </div>
            </div>
        </td>
    ...
    <tr class="table-info">
            ...
            <td> 
                        <div class="row">
                            <div class="col">
                                <input type="text" name="motivo_acu" class="form-control" placeholder="">
                            </div>
                        </div>
            </td>
    </tr>
    <tr class="table-info">
            ...
            <td>                                                             
                <div class="row">
                    <div class="col">
                        <input type="text" name="diagnostico" class="form-control" placeholder="">
                    </div>
                </div>
            </td>
...
<script type="text/javascript">
                //*******************ALERT DE ENVIO*******************/
                        ...
                        if (confirm('Estas seguro de enviar los datos de este formulario?'))
                                {       
                                        document.formulario_acu.submit();                             
...
<br>
<center>
<h3>Consultar disponibilidad Acupuntura</h3>
</center>
<br>
          <center>
...
<tbody>
	...
	<script type="text/javascript" src="js/buscar_acupuntura.js"></script>
</center>
</body>
</html>