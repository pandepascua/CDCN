...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <title>Asistencia control masoterapia</title>
</head>
...
<br>
          <center>
<form id="formulario_asistencia"action="guardado_control_asistencia_maso.php" method="post">
...
<div id="resultados"></div><!-- Carga los datos ajax -->
	...
	<script type="text/javascript" src="js/asistencia_control_maso.js"></script>
</center>
