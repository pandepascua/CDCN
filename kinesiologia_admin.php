...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <script src="js/cargar_agendamiento_kine.js"></script>
    <script src="js/cargar_alumno_fecha_kine.js"></script>

    <script src="js/carga_alumno_hora_kine.js"></script>
        <script src="js/carga_alumno_sesion_kine.js"></script>
        <script src="js/carga_alumno_sala_kine.js"></script>
        <script src="js/carga_alumno_prof_kine.js"></script>
        <script src="js/carga_alumno_elim_kine.js"></script>
...
<div style="float:right" >
  ...
  <p></p>
    ...
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#agendamiento_kine" data-whatever="@mdo">Agendamiento Control del paciente</button>
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modificacion_kine" data-whatever="@fat">modificacion agendamiento control</button>
    ...
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#eliminacion_entrevista" data-whatever="@getbootstrap">eliminar entrevista</button><br> <br>

    <a class="btn btn-primary" href="ficha_derivacion_kinesiologia_admin.php" role="button">Ingreso ficha derivacion</a>
    <a class="btn btn-primary" href="ficha_derivacion_kine_ver_admin.php" role="button">Ver datos ficha derivacion</a>
    <a class="btn btn-primary" href="ficha_derivacion_kine_mod_admin.php" role="button">Modificar ficha derivacion</a>
    <a class="btn btn-primary" href="ficha_derivacion_kine_elim_admin.php" role="button">Eliminar ficha derivacion</a><br><br>
    <a class="btn btn-primary" href="asistencia_control_kine_admin.php" role="button">Ver Asistencia, disponibilidad y agendamiento control</a>
    <a class="btn btn-primary" href="historial_asistencia_control_kine_admin.php" role="button">Ver historial asistencia agendamiento control</a><br> <br>
    <a class="btn btn-primary" href="fichakinemaso_kine_admin.php" role="button">Fichas masoterapia y kinesiología.</a><br> <br>

        <!-- ********************************************** MODAL agendamiento*********************************-->
<div class="modal fade" id="agendamiento_kine" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="formulario_kine"name="formulario_kine" action="formulario_control_kine_admin.php" method="post" target="_self">
...
<tbody>
    ...
    <tr class="table-info">
        ...
        <td> 
                    ...
                    <div class="row">
                        <div class="col">
                            <input type="hidden" id="token_runK" name="run" class="form-control" placeholder="Ej:11111111-k">
                        </div>
                    </div>
        </td>
    </tr>
  ...
  <td>                                                             
      <div class="row">
          <div class="col">
              <input type="text" id="nom_alumnoK" name="nom_alumno" class="form-control" placeholder=""required>
...
<tr class="table-info">
      ...
      <td> 
                  <div class="row">
                      <div class="col">
                          <input type="text" id="edad_alumnoK" name="edad_alumno" class="form-control" placeholder=""required>
                      </div>
                  </div>
      </td>
</tr>
<tr class="table-info">
				...
				<td> 
										<div class="row">
												<div class="col">
														<input type="date" id="fecha_nacK"name="fecha_nac" class="form-control" placeholder="" required>
												</div>
										</div>
				</td>
</tr>
    <tr class="table-info">
				...
				<td> 
										<div class="row">
												<div class="col">
														<input type="text" id="telefono_alumnoK"name="telefono_alumno" class="form-control" placeholder="" required>
												</div>
										</div>
				</td>
</tr>
<tr class="table-info">
				...
				<td>                                                             
						<div class="row">
								<div class="col">
										<input type="text" id="nom_apodK"name="nom_apod" class="form-control" placeholder="" required>
								</div>
						</div>
				</td>
</tr>
<tr class="table-info">
				...
				<td> 
										<div class="row">
												<div class="col">
														<input type="tel" id="fono_apodK"name="tel_apod" maxlength="9" class="form-control" value="9" required>
												</div>
										</div>
				</td>
</tr>
<tr class="table-info">
				...
				<td>                                                             
						<div class="row">
								<div class="col">
										<input type="text" id="direccionK" name="direc_alumno" class="form-control" placeholder="" required>
								</div>
						</div>
				</td>
</tr>
<tr class="table-info">
				...
				<td> 
										<div class="row">
												<div class="col">
														<input type="text"id="comunaK" name="comuna_alumno" class="form-control" placeholder="" required>
												</div>
										</div>
				</td>
</tr>
<tr class="table-info">
				...
				<td>                                                             
						<div class="row">
								<div class="col">
								<input type="email" id="correoK"name="correo_alumno" class="form-control" pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,5}" required>
								</div>
						</div>
				</td>
</tr>
<tr class="table-info">
				...
				<td> 
										<div class="row">
												<div class="col">
													<textarea id="patologiasK" name="patologias_alumno" cols="30" rows="4"></textarea>												
...
<button type="submit" class="btn btn-primary" style="width: 200px" value="enviar" form="formulario_kine">continuar</button>
...
<!-- ****************************************FIN AGENDAMIENTO*****************************-->
 ...
 <!-- ********************************************** MODAL MODIFICACION*********************************-->
 <div class="modal fade" id="modificacion_kine" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog"  role="document">
    <div class="modal-content"  style="width:700px">
      <div class="modal-header" >
        <h5 class="modal-title"  id="exampleModalLabel">Modificación Agendamiento</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body" >
                ...
                <p></p>
                        ...
                        <form name="mod_fecha" action="update/mod_fecha_kine_admin.php" method="post" target="_self" ONSUBMIT="return pregunta7();">
                        ...
                        <td><span>R.U.N</span></td>
                            <td> 
                                        <div class="row">
                                            <div class="col">
                                                <input type="text" id="run7" class="form-control" placeholder="Ej:11111111-k" maxlength="10"   required oninput="checkRut(this)">
                                            </div>
                                        </div>
                        ...
                        <form name="mod_hora"action="update/mod_hora_kine_admin.php" method="post" target="_self" ONSUBMIT="return pregunta2();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
                        ...
                        <form name="mod_sala" action="update/mod_sala_kine_admin.php" method="post" target="_self" ONSUBMIT="return pregunta3();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
...
<?php
        ...
        ?>
                        ...
                        <form name="mod_sesion" action="update/mod_sesion_kine_admin.php" method="post" target="_self" ONSUBMIT="return pregunta4();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
                        ...
                        <form name="mod_prof"action="update/mod_prof_kine_admin.php" method="post" target="_self" ONSUBMIT="return pregunta5();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
 ...
 <div class="modal fade" id="eliminacion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="width:700px">
      ...
      <form id="eliminar_alumno" name="eliminar_alumno"action="delete/delete_alumno_kine_admin.php" method="post" target="_self"">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
                        ...
                        <td><span>R.U.N</span></td>
                            <td> 
                                        <div class="row">
                                            <div class="col">
                                                <input type="text" id="run_alumno_el" class="form-control" placeholder="Ej:11111111-k"  maxlength="10"  required oninput="checkRut(this)">
                                                <input type="hidden" id="token_alumno_el" name="id_alumno" class="form-control" placeholder="">
                                ...
                                <td> 
                                <button type="submit" class="btn btn-success" form="eliminar_alumno" style="width: 200px" >Eliminar</button>
 ...
 <div class="modal fade" id="eliminacion_entrevista" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="width:700px">
      ...
      <form name="eliminar_alumno_entrevista"action="delete/delete_ingreso_kinesiologia_prof_admin.php" method="post" target="_self" ONSUBMIT="return preguntaE();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
                        ...
                        <td><span>R.U.N</span></td>
                            ...
                            <script type="text/javascript">
                                ...
                                <td> 
                                <button type="button" class="btn btn-success" style="width: 200px" onclick="preguntaE();">Eliminar</button>
...
<button type="button" class="btn btn-success" style="width: 200px" onclick='load(1);'>Consultar</button>
	...
	<script type="text/javascript" src="js/buscar_hora_kinesiologia.js"></script>
</center>
