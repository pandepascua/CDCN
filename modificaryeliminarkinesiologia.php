...
<div style="float:right" >
  ...
  <p></p>
        ...
        <center>
                ...
                <h3>Modificar Hora Agendamiento Kinesiología.</h3>
                <p></p>
           
                        <form name="mod_fecha" action="update/mod_fecha_kine.php" method="post" target="_self" ONSUBMIT="return pregunta();">
                        ...
                        <td><span>R.U.N</span></td>
                            <td> 
                                        <div class="row">
                                            <div class="col">
                                                <input type="text" id="run" class="form-control" placeholder="Ej:11111111-k">
                                            </div>
                                        </div>
                            </td>
                            <td><span></span></td>
                            ...
                            <td> 
                                ...
                                <div class="row">
                                    <div class="col">
                                        <input type="text" id="token_run" name="id_alumno" class="form-control" placeholder="">
                                    </div>
                                </div>
                            </td>
            ...
            <p></p>
            <br>
            <h3>Eliminar Paciente de Agendamiento Kinesiología.</h3>
            <p></p>
            <form name="eliminar_alumno"action="delete/delete_alumno_kine.php" method="post" target="_self" ONSUBMIT="return pregunta6();">
                        <table  id="tablamenu" class="table table-hover" style="width:1000px; height:150px" >
