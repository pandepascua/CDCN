...
<img src="images/logocor.png" width="100px" height="100px"/>
    ...
    <form id="form_ek2" name="form_ek2" method="post" action="guardado_formulario_ek.php">
    <table  id="tablamenu" class="table table-hover" style="width:700px; height:100px" >
                                    ...
                                    <tr class="table-info">
                                                ...
                                                <td> 
                                                            <div class="row">
                                                                <div class="col">
                                                                    <input type="text" id="run_ek" name="run_ek2"class="form-control"   maxlength="10" placeholder="11111111-k" required oninput="checkRut(this)">
                                                ...
                                                <td>                                                             
                                                    <div class="row">
                                                        <div class="col">
                                                            <input type="text" id="nom_alumno_ek" name="nombre2"  class="form-control" placeholder="">
                                                        </div>
                                                    </div>
                                                </td>
                                        ...
                                        <tr class="table-info">
                                            ...
                                            <td> 
                                                        <div class="row">
                                                            <div class="col">
                                                                <input type="date" id="fech_eva"name="fecha_ek2"  class="form-control" placeholder="aaaa/mm/dd">
                                                            </div>
                                                        </div>
                                            </td>
