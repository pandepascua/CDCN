...
<head>
        ...
        <title>Ver Ficha Derivación kinesiología</title>
</head>
...
<div style="float:right" >
  ...
  <p></p>
        ...
        <tr class="table-info">
            ...
            <form id="form_ficha_der" name="form_ficha_der"   method="post">
  ...
  ?>
                        ...
                        <table  id="tablamenu" class="table table-hover" style="width:700px; height:200px" >
                            ...
                            <tr class="table-info">
                                    ...
                                    <td> 
                                        <div class="row">
                                            <div class="col">
                                                <input type="text" id="token_al8" name="f_al" class="form-control" placeholder="">
                                            </div>
                                        </div>
                                    </td>
                                    <td><span>Edad.</span></td>
                                        <td>                                                             
                                            <div class="row">
                                                <div class="col">
                                                    <input type="text" id="token_al9" name="e_al" class="form-control" placeholder="">
                                                </div>
                                            </div>
                                        </td>
                                    </tr>          
                                    <tr class="table-info">
                                        ...
                                        <td> 
                                            <div class="row">
                                                <div class="col">
                                                    <input type="text" id="token_al10" name="est_al" class="form-control" placeholder="">
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>                                                             
                                            <div class="row">
                                                <div class="col">
                                                    <input type="text" id="token_al11" name="curso" class="form-control" placeholder="">
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="table-info">
                                        ...
                                        <td> 
                                            <div class="row">
                                                <div class="col">
                                                    <input type="text" id="token_al12"  name="dir_al" class="form-control" placeholder="">
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>                                                             
                                            <div class="row">
                                                <div class="col">
                                                    <input type="text" id="token_al13"  name="fono_al" class="form-control" placeholder="">
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                ...
                <table  id="tablamenu" class="table table-hover" style="width:700px; height:10px" >
                        <tr class="table-info">
                            ...
                            <td>  
                                <input type="text" name="doc[]"  id="token_al21">                                                           
                            </td>
