    ...
    <h3>Lista de tratamientos.</h3>
        ...
        <tbody>
            <tr class="table-info">
                ...
                <td> <ul class="nav nav-pills nav-fill"><li class="nav-item"><a class="nav-link active" href="agendamiento_terapia_ocupacional.php">Continuar</a></li></ul></td>

            </tr>
            <tr class="table-info">
                <td><span>modificar  terapia ocupacional.</span></td>
                <td> <ul class="nav nav-pills nav-fill"><li class="nav-item"><a class="nav-link active" href="mod_eli_terapia.php">Continuar</a></li></ul></td>
            </tr>
            <tr class="table-info">
                <td><span>eliminar terapia ocupacional.</span></td>
                <td> <ul class="nav nav-pills nav-fill"><li class="nav-item"><a class="nav-link active" href="eli_terapia.php">Continuar</a></li></ul></td>
            </tr>
        </tbody>
        </table>
    </form>
