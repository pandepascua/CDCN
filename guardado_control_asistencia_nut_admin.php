...
if (isset($_POST['asistencia'] )) {
 ...
 $sql_asis="insert into asistencia_control_nut(
 fecha_nutricion ,
 hora_nutricion ,
 run_alumno ,
 nom_alumno , 
...
'$array_correo','$array_mot','$array_sesion','$array_diag','$array_obse',$array_check,$array_ag,$array_sala,$array_taller,$array_prof
);";
  //var_dump($sql_asis);

if($conexion -> query($sql_asis) == True){      
    echo '<script> alert("Datos Registrados. Serás redireccionado a la página.");window.location.href="asistencia_control_nut_admin.php";</script>';
}else{
