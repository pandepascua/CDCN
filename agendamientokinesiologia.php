...
<meta charset="UTF-8">
    ...
    <title>Agendamiento Kinesiología</title>
</head>
...
<center>
    ...
    <h3>Agendamiento Kinesiología</h3>
    <br>
    <form name="formulario_kine" action="guardar_DAK.php" method="post" target="_self" ONSUBMIT="return pregunta();">
...
<tbody>
    <tr class="table-info">
        <td>
            ...
            <input type="date" name="fecha_kine" min="2019-01-01"
                                            max="2030-01-01" step="1">
           
       </td>
        <td>  <!-- Campo de entrada de hora -->
            
            <input type="time" name="hora_kine" min="09:00"
                                           max="18:00" step="1800">
        </td>
        <td>
                        <th   style="width:300px" scope="col"><input type="hidden"></th>
    ...
    <tr class="table-info">
        ...
        <td>                                                             
            <div class="row">
                <div class="col">
                    <input type="text"  id="nombre_kine"  class="form-control" placeholder="">
                </div>
            </div>
        </td>
    ...
    <tr class="table-info">
            ...
            <td> 
                        <div class="row">
                            <div class="col">
                                <input type="text" id="edad_kine"  class="form-control" placeholder="">
                            </div>
                        </div>
            </td>
            ...
            <td>                                                             
                <div class="row">
                    <div class="col">
                        <input type="text" id="telefono_kine" class="form-control" placeholder="">
                    </div>
                </div>
            </td>
    </tr>
    ...
    <tr class="table-info">
            ...
            <td>                                                             
                <div class="row">
                    <div class="col">
                        <input type="text" id="atencion_kine" name="atencion_kine" class="form-control" placeholder="">
                    </div>
                </div>
            </td>
    </tr>
    <tr class="table-info">
            ...
            <td> 
                        <div class="row">
                            <div class="col">
                                <input type="text" id="observacion_kine" name="observacion_kine" class="form-control" placeholder="">
                            </div>
                        </div>
            </td>
            ...
            <td>                                                             
                <div class="row">
                    <div class="col">
                        <input type="text" id="sesion_kine" name="sesion_kine" class="form-control" placeholder="">
                    </div>
                </div>
            </td>
    </tr>
    <tr class="table-info">
            ...
            <td> 
                        <div class="row">
                            <div class="col">
                                <input type="text" id="estado_kine" name="estado_kine" class="form-control" placeholder="">
                            </div>
                        </div>
            </td>
            ...
            <td>                                                             
                <div class="row">
                    <div class="col">
                        <input type="text" id="ejercicio_kine" name="ejercicio_kine" class="form-control" placeholder="">
                    </div>
                </div>
            </td>
    </tr>
    <tr class="table-info">
            ...
            <td> 
                        <div class="row">
                            <div class="col">
                                <input type="text" id="tens_kine" name="tens_kine" class="form-control" placeholder="">
                            </div>
                        </div>
            </td>
        ...
        <td> 
            <div class="row">
            <div class="col">
                <input type="text" id="us_kine" name="us_kine" class="form-control" placeholder="">
            </div>
            </div>
        </td>
    </tr>                
    <tr class="table-info">
        ...
        <td> 
            <div class="row">
                <div class="col">
                     <input type="text" id="chc_kine" name="chc_kine" class="form-control" placeholder="">
                </div>
            </div>
        </td>
        ...
        <td> 
            <div class="row">
                <div class="col">
                    <input type="text" id="ir_kine" name="ir_kine" class="form-control" placeholder="">
                </div>
            </div>
        </td>
    </tr>
...
<script type="text/javascript">
                //*******************ALERT DE ENVIO*******************/
                        ...
                        if (confirm('Estas seguro de enviar los datos de este formulario?'))
                                {       
                                        document.formulario_kine.submit();                             
...
<br>
<center>
<h3>Ver disponibilidad Kinesiología</h3>
</center>
<br>
...
<tbody>
	...
	<script type="text/javascript" src="js/buscar_kinesiologia.js"></script>
</center>
</body>
</html>