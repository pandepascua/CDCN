...
<head>
        ...
        <title>Ingreso Ficha Derivación</title>
</head>
...
<div style="float:right" >
  ...
  <p></p>
        ...
        <tr class="table-info">
            ...
            <td>
            <input type="text" name="run" id=""maxlength="10" placeholder="11111111-k" required oninput="checkRut(this)">

            </td>
        </tr>
        </table>
            <form id="form_ficha_der" name="form_ficha_der"  action="g_ficha_der_acu_admin.php" method="post">
