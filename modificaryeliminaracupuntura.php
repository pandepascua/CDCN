  ...
  <p></p>
        ...
        <center>
                ...
                <p></p>
                        ...
                        <form name="mod_fecha" action="update/mod_fecha_acu.php" method="post" target="_self" ONSUBMIT="return pregunta();">
                        ...
                        <form name="mod_hora"action="update/mod_hora_acu.php" method="post" target="_self" ONSUBMIT="return pregunta2();">
                        <table  id="tablamenu" class="table table-hover" style="width:1000px; height:150px" >
                        ...
                        <form name="mod_sala" action="update/mod_sala_acu.php" method="post" target="_self" ONSUBMIT="return pregunta3();">
                        <table  id="tablamenu" class="table table-hover" style="width:1000px; height:150px" >
                        ...
                        <form name="mod_sesion" action="update/mod_sesion_acu.php" method="post" target="_self" ONSUBMIT="return pregunta4();">
                        <table  id="tablamenu" class="table table-hover" style="width:1000px; height:150px" >
                        ...
                        <form name="mod_prof"action="update/mod_prof_acu.php" method="post" target="_self" ONSUBMIT="return pregunta5();">
                        <table  id="tablamenu" class="table table-hover" style="width:1000px; height:150px" >
            ...
            <p></p>
            <br>
            <h3>Eliminar Paciente de Agendamiento Acupuntura</h3>
            <p></p>
            <form name="eliminar_alumno"action="delete/delete_alumno_acu.php" method="post" target="_self" ONSUBMIT="return pregunta5();">
                        <table  id="tablamenu" class="table table-hover" style="width:1000px; height:150px" >
