...
<div style="float:right" >
  ...
  <p></p>
    ...
    <p></p>
    <a class="btn btn-primary" href="fichakinemaso.php" role="button">Ir Atrás</a>     
    <p></p>
    <center>
    ...
    <h3>Formulario Datos generales</h3>
        <form id="formulario_el" name="formulario_dg" action="delete/elim_dg.php" method="post" target="_self">
...
<tr class="table-info">
  ...
  <td> 
              <div class="row">
                  <div class="col">
                      <input type="text"  name="id_dg2" class="form-control"  value="<?php echo $_POST['id_dg_el']?>">
                  </div>
              </div>
...
<tr class="table-info">
  ...
  <td> 
              <div class="row">
                  <div class="col">
                      <input type="text" id="run_alumno" name="run" class="form-control" maxlength="10" value="<?php echo $_POST['run3_el']?>" required oninput="checkRut(this)" readonly>
                  </div>
              </div>
...
<tr class="table-info">
  ...
  <td>                                                             
      <div class="row">
          <div class="col">
              <input type="text" id="nom_alumno" name="nombre" value="<?php echo $_POST['nombre_el']?>" class="form-control" placeholder=""required>
          </div>
      </div>
  </td>
...
<tr class="table-info">
      ...
      <td> 
                  <div class="row">
                      <div class="col">
                          <input type="text" id="edad_alumno" name="edad" value="<?php echo $_POST['edad_el']?>" class="form-control" placeholder=""required>
                      </div>
                  </div>
      </td>
</tr>
<tr class="table-info">
      ...
      <td>                                                             
          <div class="row">
              <div class="col">
                  <input type="text" id="telefono_alumno" name="celular" value="<?php echo $_POST['celular_el']?>" class="form-control" placeholder=""required>
              </div>
          </div>
      </td>
</tr>
<tr class="table-info">
     ...
     <td><span>Taller seleccionado.</span></td>
        <td>                                                             
            <div class="row">
                <div class="col">
                    <input type="text" id="token_dg29" class="form-control" name="" value="<?php echo $_POST['taller_el']?>">
            </div>
        </div>
    </td>
</tr>
<tr class="table-info">
				...
				<td> 
					<div class="row">
						<div class="col">
							<input type="date" name="fecha_nac" class="form-control" value="<?php echo $_POST['fecha_nac_el']?>" placeholder="" required>
						</div>
					</div>
				</td>
</tr>
...
<tr class="table-info">
				...
				<td>                                                             
						<div class="row">
								<div class="col">
										<input type="text" name="direccion" class="form-control" value="<?php echo $_POST['direccion_el']?> " required>
								</div>
						</div>
				</td>
</tr>
...
<tr class="table-info">
				...
				<td>                                                             
						<div class="row">
								<div class="col">
								<input type="email" name="correo" class="form-control" pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,5}" value="<?php echo $_POST['correo_el']?> "required>
								</div>
						</div>
				</td>
</tr>
<tr class="table-info">
				...
				<td> 
										<div class="row">
												<div class="col">
													<input type="text" style="width:300px" name="patologia"  value="<?php echo $_POST['patologia_el']?> ">												
...
<tr class="table-info">
      ...
      <td>                                                             
          <div class="row">
              <div class="col">
                  <input type="text" id="token_dg10" name="diagnostico" class="form-control" value="<?php echo $_POST['diagnostico_el']?> "required>
              </div>
          </div>
      </td>
</tr>
...
<tr class="table-info">
    <td><span>Ocupacion.</span></td>
       <td> 
            <div class="row">
                <div class="col">
                   <input type="text" id="token_dg11" name="ocupacion" class="form-control" placeholder="" value="<?php echo $_POST['ocupacion_el']?> ">
            </div>
       </div>
    </td>
</tr>
...
<tr class="table-info">
      <td><span>Fecha ingreso ingresado.</span></td>
            ...
            <div class="row">
                <div class="col">
                <input  id="token_dg12" type="input" class="form-control"  value="<?php echo $_POST['fecha_ingreso_el']?> ">
      ...
      <td><span>Motivo de consulta.</span></td>
        ...
        <td><textarea name="motivo" id="token_dg13" cols="25" rows="2"  placeholder="ingrese motivo de consulta"><?php echo $_POST['motivo_el']?> </textarea></td>
 </tr>
</tbody>
                        ...
                        if(columna>1){
                                $("#tabla_ant_far tr:last").remove();
                                        ...
                                        <table  id="tablamenu" class="table table-hover" style="width:100px; height:100px" >
                                                <tbody>
                                                    <tr class="table-info">
                                                        <td><textarea id="token_dg26" name="actividad_fisica" id="" cols="50" rows="2" placeholder=""><?php echo $_POST['act_fisica_el']?> </textarea></td>
                                                    </tr>
                                                </tbody>
                                        </table>
                                        <p>
                                        ...
                                        <table  id="tablamenu" class="table table-hover" style="width:100px; height:100px" >
                                                <tbody>
                                                    <tr class="table-info">
                                                        <td><textarea name="anamnesis"id="token_dg27"cols="50" rows="2" placeholder=""><?php echo $_POST['anamnesis_el']?> </textarea></td>
                                                    </tr>
                                                </tbody>
                                        </table>          
        <button type="submit" class="btn btn-primary" style="width: 200px" value="enviar" form="formulario_el" >Enviar Datos</button>
