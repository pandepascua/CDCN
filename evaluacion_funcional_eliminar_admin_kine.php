...
<div style="float:right" >
  ...
  <p></p>
        ...
        <form name="formulario_evaluacion_eli" id="eliminar_evaluacion" action="delete/delete_evaluacion_admin_kine.php" method="post" target="_self" ONSUBMIT="return pregunta();">
<center>
