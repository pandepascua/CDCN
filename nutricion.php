...
<div style="float:right" >
  ...
  <p></p>
    ...
    <a class="btn btn-primary" href="ficha_derivacion_nutricion.php" role="button">Ingreso ficha derivacion</a><br><br>
    <a class="btn btn-primary" href="ficha_derivacion_nut_ver.php" role="button">Ver datos ficha derivacion</a>
    <a class="btn btn-primary" href="ficha_derivacion_nut_mod.php" role="button">Modificar ficha derivacion</a>
    <a class="btn btn-primary" href="ficha_derivacion_nut_elim.php" role="button">Eliminar ficha derivacion</a>

    <a class="btn btn-primary" href="asistencia_control_nut.php" role="button">Ver Asistencia, disponibilidad y agendamiento control</a>

    <a class="btn btn-primary" href="historial_asistencia_control_nut.php" role="button">Ver historial asistencia agendamiento control</a><br> <br>
...
<div class="modal fade" id="agendamiento_nut" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="formulario_nut" name="formulario_acu" action="formulario_control_nut.php" method="post" target="_blank">
    ...
    <div class="modal-content"  style="width:700px">
      ...
      <div class="modal-body" >
                <p></p>
                        ...
                        <form name="mod_fecha" action="update/mod_fecha_nut.php" method="post" target="_self" ONSUBMIT="return pregunta7();">
                        ...
                        <form name="mod_hora"action="update/mod_hora_nut.php" method="post" target="_self" ONSUBMIT="return pregunta2();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
                        ...
                        <form name="mod_sala" action="update/mod_sala_nut.php" method="post" target="_self" ONSUBMIT="return pregunta3();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
...
<?php
        ...
        ?>
                        ...
                        <form name="mod_sesion" action="update/mod_sesion_nut.php" method="post" target="_self" ONSUBMIT="return pregunta4();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
                        ...
                        <form name="mod_prof"action="update/mod_prof_nut.php" method="post" target="_self" ONSUBMIT="return pregunta5();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
 ...
 <div class="modal fade" id="eliminacion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="width:700px">
      ...
      <form name="eliminar_alumno"action="delete/delete_alumno_nut.php" method="post" target="_self" ONSUBMIT="return pregunta5();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
 ...
 <div class="modal fade" id="eliminacion_ent" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="width:700px">
      ...
      <form name="eliminar_ent"action="delete/delete_ingreso_nut_prof.php" method="post" target="_self" ONSUBMIT="return e_ent();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
