...
<head>
    ...
    <script src="js/cargar_agendamiento_terapia.js"></script>
    <script src="js/cargar_alumno_fecha_terapia.js"></script>
    <script src="js/carga_alumno_elim_terapia.js"></script>
    <link rel="shortcut icon" type="image/icon" href="images/favicon.ico"/>

    <script src="js/carga_alumno_hora_terapia.js"></script> 
...
<div class="modal fade" id="agendamiento_nut" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form name="formulario_agen_nu" action="guardar_hora_terapia_admin.php" method="post" target="_self" ONSUBMIT="return pregunta();">
...
<tbody>
    <tr class="table-info">
        <td>
            ...
            <input type="date" name="fecha_terapia" min="2019-01-01"
                                            max="2030-01-01" step="1">
           
          </td>
        <td>  <!-- Campo de entrada de hora -->
            
            <input type="time" name="hora_terapia" min="09:00"
                                           max="18:00" step="1800">
        </td>
    ...
    <div class="modal-content"  style="width:700px">
      ...
      <div class="modal-body" >
                <p></p>
                        ...
                        <form name="mod_fecha" action="update/mod_fecha_ingreso_terapia_admin.php" method="post" target="_self" ONSUBMIT="return pregunta7();">
                        ...
                        <td><span>R.U.N</span></td>
                            <td> 
                                        <div class="row">
                                            <div class="col">
                                                <input type="text" id="run_alumno7" class="form-control" placeholder="11111111-1" required oninput="checkRut(this)">
                                            </div>
                                        </div>
                        ...
                        <form name="mod_hora"action="update/mod_hora_ingreso_terapia_admin.php" method="post" target="_self" ONSUBMIT="return pregunta2();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
                        ...
                        <td><span>R.U.N</span></td>
                            <td> 
                                        <div class="row">
                                            <div class="col">
                                                <input type="text" id="run_alumno2" class="form-control" placeholder="11111111-1" required oninput="checkRut(this)">
                                            </div>
                                        </div>
 ...
 <div class="modal fade" id="eliminacion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="width:700px">
      ...
      <form name="eliminar_alumno"action="delete/delete_ingreso_terapia_admin.php" method="post" target="_self" ONSUBMIT="return pregunta5();">
                        <table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
                        ...
                        <td><span>R.U.N</span></td>
                            <td> 
                                        <div class="row">
                                            <div class="col">
                                                <input type="text" id="run_alumno6" class="form-control" placeholder="11111111-1" required oninput="checkRut(this)">
...
<form action="filtro_agendamiento_terapia.php" method="post"></form>
...
<button type="button" class="btn btn-success" style="width: 200px" onclick='load(1);'>Consultar</button>
	...
	<script type="text/javascript" src="js/buscar_hora_terapia.js"></script>
</center>
