...
<meta charset="UTF-8">
    ...
    <title>Modificación ficha masoterapia y kinesiología</title>
</head>
...
<form id="formulario_maso_mod" name="formulario_maso_mod"  action="mod_masoterapia_admin_kine.php" method="post">   
