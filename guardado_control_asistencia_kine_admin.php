...
$bd="cdcn";
 ...
 $sql_asis="insert into asistencia_control_kine(
 fecha_kin ,
  hora_kine ,
  run_alumno ,
  nom_alumno , 
...
if($conexion -> query($sql_asis) == True){      
    echo '<script> alert("Datos Registrados. Serás redireccionado a la página.");window.location.href="asistencia_control_kine_admin.php";</script>';
}else{
