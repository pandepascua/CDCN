...
<div style="float:right" >
  ...
  <p></p>
    ...
    <a class="btn btn-primary" href="ficha_derivacion_acupuntura.php" role="button">Ingreso ficha derivacion</a>
    <a class="btn btn-primary" href="ficha_derivacion_acu_ver.php" role="button">Ver datos ficha derivacion</a>
    <a class="btn btn-primary" href="ficha_derivacion_acu_mod.php" role="button">Modificar ficha derivacion</a>
    <a class="btn btn-primary" href="ficha_derivacion_acu_elim.php" role="button">Eliminar ficha derivacion</a><br><br>
    ...
    <a class="btn btn-primary" href="asistencia_control_acu.php" role="button">Ver Asistencia, disponibilidad y agendamiento control</a>
    <a class="btn btn-primary" href="historial_asistencia_control_acu.php" role="button">Ver historial asistencia agendamiento control</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="width:700px">
      ...
      <form name="eliminar_alumno_entrevista"action="delete/delete_ingreso_acupuntura_prof.php" method="post" target="_self" ONSUBMIT="return pregunta5();">
...
<div class="modal fade" id="agendamiento" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="formulario_acu" name="formulario_acu" action="formulario_control_acu.php" method="post" target="_self">
...
<tbody>
    <tr class="table-info">
        ...
        <td> 
                    ...
                    <div class="row">
                        <div class="col">
                            <input type="hidden" id="token_run" name="run_acu" class="form-control" placeholder="Ej:11111111-k">
                        </div>
                    </div>
        </td>
    </tr>
  ...
  <div class="modal-dialog"  role="document">
    <div class="modal-content"  style="width:700px">
      ...
      <h3>Modificar Hora Agendamiento Acupuntura</h3>
                ...
                <form id="mod_fecha" name="mod_fecha" action="update/mod_fecha_acu.php" method="post" target="_self" >
...
<form id="mod_hora" name="mod_hora"action="update/mod_hora_acu.php" method="post" target="_self" >
<table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
...
<form id="mod_sala" name="mod_sala" action="update/mod_sala_acu.php" method="post" target="_self" >
<table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
...
<form id="mod_sesion" name="mod_sesion" action="update/mod_sesion_acu.php" method="post" target="_self" >
<table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
...
<form id="mod_prof" name="mod_prof"action="update/mod_prof_acu.php" method="post" target="_self" >
<table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
...
<form id="eliminar_alumno"name="eliminar_alumno"action="delete/delete_alumno_acu.php" method="post" target="_self" >
<table  id="tablamenu" class="table table-hover" style="width:650px; height:150px" >
    ...
    <td> 
                <div class="row">
                    <div class="col">
                        ...
                        <input type="hidden" id="token_run_el" name="id_alumno" class="form-control" placeholder="">
