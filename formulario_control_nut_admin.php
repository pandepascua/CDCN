...
<?php
    ...
    <link rel="shortcut icon" type="image/icon" href="images/favicon.ico"/>
            ...
            <title>Formulario control nutrición</title>
        </head>
...
<div style="float:right" >
  ...
  <p></p>
        ...
        <p></p>
                <a class="btn btn-primary" href="nutricion_admin.php" role="button">Ir Atrás</a>     
                <p></p>
                <center>

        <h3>Formulario de agendamiento control</h3>
        <form id="formulario_nut" name="formulario_nut" action="guardar_DAN2.php" method="post" target="_self">
...
<tr class="table-info">
  ...
  <td> 
              <div class="row">
                  <div class="col">
                      <input type="text" id="run_alumno" name="run_al" class="form-control" maxlength="10" value="<?php echo $_POST['run_al']?>" required oninput="checkRut(this)" readonly="readonly">
                  </div>
              </div>
...
<tr class="table-info">
  ...
  <td>                                                             
      <div class="row">
          <div class="col">
              <input type="text" id="nom_alumno" name="nom_alumno" value="<?php echo $_POST['nom_alumno']?>" class="form-control" placeholder="" readonly="readonly" required>
          </div>
      </div>
  </td>
...
<tr class="table-info">
      ...
      <td> 
                  <div class="row">
                      <div class="col">
                          <input type="text" id="edad_alumno" name="edad" value="<?php echo $_POST['edad_alumno']?>" class="form-control" placeholder="" readonly="readonly" required>
                      </div>
                  </div>
      </td>
</tr>
...
<?php
    ...
    inner join talleres on(alumnos.id_taller=talleres.id_taller) where run_alumno="'.$_POST['run_al'].'"');
...
<tr class="table-info">
				...
				<td> 
										<div class="row">
												<div class="col">
														<input type="date" name="fecha_nac2" class="form-control" value="<?php echo $_POST['fecha_nac']?>" placeholder="" readonly="readonly" required>
												</div>
										</div>
				</td>
</tr>
<tr class="table-info">
				...
				<td>                                                             
						<div class="row">
								<div class="col">
										<input type="text" name="nom_apod" class="form-control" value="<?php echo $_POST['nom_apod']?>" readonly="readonly" required>
								</div>
						</div>
				</td>
</tr>
<tr class="table-info">
				...
				<td> 
										<div class="row">
												<div class="col">
														<input type="tel" name="tel_apod" maxlength="9" class="form-control" value="<?php echo $_POST['tel_apod']?>" readonly="readonly" required>
												</div>
										</div>
				</td>
</tr>
<tr class="table-info">
				...
				<td>                                                             
						<div class="row">
								<div class="col">
										<input type="text" name="direc_alumno" class="form-control" value="<?php echo $_POST['direc_alumno']?> " readonly="readonly" required>
								</div>
						</div>
				</td>
</tr>
<tr class="table-info">
				...
				<td> 
										<div class="row">
												<div class="col">
														<input type="text" name="comuna_alumno" class="form-control" value="<?php echo $_POST['comuna_alumno']?> " readonly="readonly" required>
												</div>
										</div>
				</td>
</tr>
<tr class="table-info">
				...
				<td>                                                             
						<div class="row">
								<div class="col">
								<input type="email" name="correo_alumno" class="form-control" pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,5}" value="<?php echo $_POST['correo_alumno']?> " readonly="readonly" required>
								</div>
						</div>
				</td>
</tr>
<tr class="table-info">
				...
				<td> 
										<div class="row">
												<div class="col">
													<input type="text" style="width:300px" name="patologia_alumno"  value="<?php echo $_POST['patologias_alumno']?>" readonly="readonly">												
...
<tr class="table-info">
      ...
      <td> 
                  <div class="row">
                      <div class="col">
                          <input type="text" name="motivo" class="form-control" placeholder=""required>
                      </div>
                  </div>
      </td>
</tr>
