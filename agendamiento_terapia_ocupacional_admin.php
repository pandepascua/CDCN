...
<body style="margin: 25px 50px 75px">
                ...
                <p></p>
                <a class="btn btn-primary" href="menu_terapia_admin.php" role="button">Ir Atrás</a>     
...
<center>
    ...
    <form name="formulario_terapia" action="guardar_terapia_admin.php" method="post" target="_self" ONSUBMIT="return pregunta();">
...
<tbody>
    ...
    <td><span>Motivo de derivación</span></td>
        ...
        <td> 
            <div class="row">
                <div class="col">
                     <input type="text"  id="sala" name="sala" class="form-control" placeholder="">
                </div>
            </div>
        </td>
